...
<div class="page-header">
        ...
        <form action="{{ route('jugadores.index') }}" method="GET" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
<div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="#">
                <div class="form-group row">
                    ...
                    <p class="form-control-static col-sm-10">{{$jugador->id + 2}}</p>
                </div>
                <div class="form-group row">
